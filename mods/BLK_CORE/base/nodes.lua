...
blk.ladder("maple_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("pine_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("cedar_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("aspen_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("elm_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("palm_ladder", {ladder = 1, choppy = 1}, blk.sounds("wood"))
blk.ladder("iron_ladder", {iron_ladder = 1, ladder = 1, cracky = 1}, blk.sounds("metal"))
