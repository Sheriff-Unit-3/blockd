local cotton = blk.mod()..":cotton"
local wheat = blk.mod()..":wheat"
local carrot = blk.mod()..":carrot"
local beet = blk.mod()..":beet"
local rice = blk.mod()..":rice"
...
blk.crop("rice", 4, {[nici] = 1, rice_plant = 1, snappy = 1},
  ...
  {rarity = 2,items = {rice.."_seeds", rice.."_seeds"}},
  {rarity = 1,items = {rice.."_seeds", rice.."_seeds"}}
}})
blk.crop("rice", -1, {rice = 1, seeds = 1, crop = 1}, "", rice.."_1")
blk.grow("rice", 30, 5)
